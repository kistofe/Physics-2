...
class // TODO 6: Create a small class that keeps a pointer to tghe b2Body
...
public:
	...
	void CreateCircle(int x, int y, float _radius);
	void CreateRectangle(int x, int y, float hx, float hy);
